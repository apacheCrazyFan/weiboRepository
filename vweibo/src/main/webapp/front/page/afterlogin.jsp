...
=======
		...
		<ul>
			...
			<li><a href="javascript:void(0)" class="gamePage">游戏</a></li>
			<li><a
				href="front/page/Personal.jsp?operation=findpersonal&WBUid=${sessionScope.user.WBUid}"
				class="personPage">${sessionScope.user.uname}</a></li>
		</ul>
		<div class="settingArea">
			<a href="javascript:void(0)" class="message_pic"></a> <a
				href="front/page/UserSet.jsp?WBUid=${sessionScope.user.WBUid}"
		...
		<div id="center-part">
			...
			<div id="navigation" style="display: block">
				<a href="javascript:void(0)" id="na1">全部</a> <a
					...
					href="javascript:void(0)" id="na1">音乐</a>
				<div id="nav_search">

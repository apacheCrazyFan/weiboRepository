		...
		$.ajaxFileUpload({
					...
					success : function(data, status) {
						if (data.rate == -1) {
							...
							newWeiBoStr += '<a href="javascript:void(0)" class="center-part_way" id="center-part_way" onClick="'
									+ 'showcenterhidediv("center-partchoose")'
									+ 'onMouseOver="'
									+ 'changecentercolor("center-part_way") onMouseOut="changecentercolors("'
									+ 'center-part_way")"><img src="front/image/conter-part_wayimg01.png"/></a>';
							...
							newWeiBoStr += '<a href="javascript:void(0)" id="center_footnum1" onClick="addcollectiondiv("'
									+ 'center_footnum1_col")"><img src="front/image/center-part_foot01.png" id="foot01_imgs"/>收藏</a>';
							newWeiBoStr += '<a href="javascript:void(0)" id="center_footnum2" onClick="addtransmitdiv("'
									+ 'center_footnum2_transmit")"><img src="front/image/center-part_foot02.png" id="foot01_img"/>204</a>';
...
<body id="bg">
	<div id="header">
		...
		<div class="searchTextBorder">
			<input type="text" class="searchText" placeholder="微微一笑很倾城"
				onClick="searchClick()" onBlur="searchBlur()" /> <a
				href="javascript:void(0)" class="search_pic"></a>
		</div>
		<ul>
		...
		<div class="settingArea">
			<a href="javascript:void(0)" class="message_pic"></a> <a
				href="javascript:void(0)" class="setting_pic"></a> <a
				href="javascript:void(0)" class="sendMess_pic"></a>
		</div>
	</div>
	...
	<div id="frame">
		<div id="left-part">
			...
			<ul id="left-part-content">
				...
				<li style="height: 25px;"><img
					...
					href="javascript:void(0)" id="two">热门微博</a></li>
				<li style="height: 25px;"><img
					src="front/image/afterlogin_logo2.jpg" class="img1" /><a
					href="javascript:void(0)" id="two">好友圈</a></li>
				<li style="height: 25px;"><img
					src="front/image/afterlogin_logo3.jpg" class="img1" /><a
					href="javascript:void(0)" id="two">群微博</a></li>
				<li style="height: 25px;"><img
					src="front/image/afterlogin_logo4.jpg" class="img" /><a
					href="javascript:void(0)" id="two">特别关注</a></li>
				<li style="height: 25px;"><img
					src="front/image/afterlogin_logo5.jpg" class="img2" /><a
					href="javascript:void(0)" id="two">大学</a></li>
				<li style="height: 25px;"><img
					src="front/image/afterlogin_logo5.jpg" class="img2" /><a
					href="javascript:void(0)" id="two">搞笑</a></li>
				<li style="height: 25px;"><img
					src="front/image/afterlogin_logo5.jpg" class="img2" /><a
					href="javascript:void(0)" id="two">时尚</a></li>
			</ul>
		...
		<div id="center-part">
			<div id="center-part-content">
				<p>
					<span id="s1"><img src="front/image/weibonav.png" /></span> <a
						href="javascript:void(0)"><span id="s2" style="color: red;">王宝强，马蓉离婚案</span></a>
				</p>
				<form action="" method="" enctype="multipart/form-data"
					...
					<input id="form_push_op" name="op" value="0" type="hidden" /> <a
						...
						onClick="showUploadPicsNone('myPicFile')" id="wword"><img
						src="front/image/write_img2.png" id="wimg" />图片</a> <a
						href="javascript:void(0)"
						onClick="showUploadVideosNone('myVideoFile')" id="wword"><img
						src="front/image/write_img3.png" id="wimg" />视频</a> <a
						href="javascript:void(0)" id="wword"><img
						src="front/image/write_img4.png" id="wimg" />话题</a> <a
						href="javascript:void(0)" id="wword"><img
						src="front/image/write_img5.png" id="wimg" />头条文章</a> <a
						href="javascript:void(0)" class="wword" id="moreimg"
					...
					<div id="uploadPics">
						<input type="file" name="myPicFile" multiple="multiple"
							id="myPicFile" style="display: none;" />
					</div>
					<div id="uploadVideo">
						<input type="file" name="myVideoFile" multiple="multiple"
							id="myVideoFile" style="display: none;" />
					</div>
				</form>
				...
				<div id="choose" style="display: none;" onMouseUp="hidediv()">
					<a href="javascript:void(0)" id="choosea1"><img
						...
						</li></a><br> <a href="javascript:void(0)" id="choosea1"><img
					...
					<a href="javascript:void(0)" id="choosea1"><img
						...
						style="position: relative; bottom: 8px;" />
						<li class="c1" id="choose4" data="3" onClick="changeword(this)"
						style="height: 12px; position: relative; bottom: 8px;">群可见</li></a>
				</div>

				<div id="face_image" style="display: none;">
					<!-- z-index应该是要和position一起用， -->
					<!-- this指针只能放在事件里面用  onClick  onMouseOver等 -->
					<a href="javascript:void(0)" onClick="clickFace(this)" data="[大哭]"><img
						src="front/image/face_image/daku003.png"></a> <a
						href="javascript:void(0)" onClick="clickFace(this)" data="[大笑]"><img
						src="front/image/face_image/daxiao007.png"></a> <a
						href="javascript:void(0)" onClick="clickFace(this)" data="[可怜]"><img
						src="front/image/face_image/keling006.png"></a> <a
						href="javascript:void(0)" onClick="clickFace(this)" data="[抠鼻]"><img
						src="front/image/face_image/koubi005.png"></a> <a
						href="javascript:void(0)" onClick="clickFace(this)" data="[衰]"><img
						src="front/image/face_image/shuai004.png"></a> <a
						href="javascript:void(0)" onClick="clickFace(this)" data="[微笑]"><img
						src="front/image/face_image/weixiao001.png"></a> <a
						href="javascript:void(0)" onClick="clickFace(this)" data="[赞]"><img
						src="front/image/face_image/zan002.png"></a>
				</div>
			...
			<div id="navigation" style="display: block">
				<a href="javascript:void(0)" id="na1">全部</a> <a
					href="javascript:void(0)" id="na1">原创</a> <a
					href="javascript:void(0)" id="na1">视频</a> <a
					href="javascript:void(0)" id="na1">图片</a> <a
					href="javascript:void(0)" id="na1">音乐</a> <a
					href="javascript:void(0)" id="na1">文章</a>
				<div id="nav_search">
					<input type="text" id="search_text" placeholder="搜索我关注人的微博" /> <a
						href="javascript:void(0)"><img
						src="front/image/icon_search.png" id="nav-search" /></a> <a
			...
			<div id="supersearch"
				...
				类&nbsp;&nbsp;&nbsp;型：<input type="checkbox" id="check"
					checked="checked" style="margin-top: 30px;" />原创 <input
					type="checkbox" checked="checked" id="check" />转发&nbsp;&nbsp; <input
					type="checkbox" checked="checked" id="check" />纯文字&nbsp;&nbsp; <input
					type="checkbox" checked="checked" id="check" />含图片&nbsp;&nbsp; <input
					type="checkbox" checked="checked" id="check" />含视频&nbsp;&nbsp; <input
					type="checkbox" checked="checked" id="check" />含音乐&nbsp;&nbsp; <input
					type="checkbox" checked="checked" id="check" />含文章<br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;关键字：<input type="text"
			...
			<div id="xixi">
				<div id="center-part-content_01" style="margin-top: 20px;">
					<a href="javascript:void(0)" id="center-part_img"
						class="center-part_img"><img title="啦啦啦"
						src="front/image/userphoto003.png" /></a> <a
						href="javascript:void(0)" class="center-part_way"
						id="center-part_way"
						onClick='showcenterhidediv("center-partchoose")'
						onMouseOver="changecentercolor('center-part_way')"
						onMouseOut="changecentercolors('center-part_way')"><img
						src="front/image/conter-part_wayimg01.png" /></a>
					<div style="display: none;" class="center-partchoose"
						id="center-partchoose"
						onMouseUp="hidecenterdiv('center-partchoose')">
						<ul>
					...
					<ul id="center-part_ul"
						style="width: 180px; position: relative; left: -140px;">
						<li id="center-part_li"
							style="height: 0px; position: relative; left: 18px; top: 15px;">APP菌</li>
						<li style="height: 0px; width: 150px;"><a
							href="javascript:void(0)">8</a>分钟前 来自 weibo.com</li>
					</ul>
					<p id="center-part_p"
						style="width: 500px; position: relative; left: 29px;">【The
						Clocks】跟Fliqlo类似，都是拍照时候的背景神器[
					...
					<div id="center_footnum" class="center_footnum">
						<a href="javascript:void(0)" id="center_footnum1"
							...
							onClick="addcommentdiv('comment_div')"><img
					...
					<div id="center_footnum2_transmit" class="center_footnum2_transmit"
						...
						<div id="transmit_choose" class="transmit_choose"
							style="display: none;"
				...
				<div id="center-part-content_01">
					<a href="javascript:void(0)" id="center-part_img"><img
						src="front/image/userphoto001.png" /></a> <a
						href="javascript:void(0)" class="center-part_way"
						id="center-part_way1"
					...
					<ul id="center-part_ul"
						style="width: 180px; position: relative; left: -140px;">
						<li id="center-part_li"
							style="height: 0px; position: relative; left: 18px; top: 15px;">百科酱</li>
						<li style="height: 0px; width: 150px;"><a
							href="javascript:void(0)">3</a>小时前 来自 weibo.com</li>
					</ul>
					<p id="center-part_p"
						style="width: 500px; position: relative; left: 29px;">阿里巴巴集团董事局主席马云成功的十大法则！不要抱怨，寻找机会，时刻拥有梦想，尊重文化，取一个好听的名字</p>
					<div id="content_img01">
				...
				<div id="center-part-content_01">
					<a href="javascript:void(0)" id="center-part_img"><img
						src="front/image/userphoto004.png" /></a> <a
						href="javascript:void(0)" class="center-part_way"
						id="center-part_way2"
					...
					<ul id="center-part_ul"
						style="width: 180px; position: relative; left: -140px;">
						<li id="center-part_li"
							style="height: 0px; position: relative; left: 18px; top: 15px;">网易云音乐</li>
						<li style="height: 0px; width: 150px;"><a
							href="javascript:void(0)">20</a>分钟前 来自 weibo.com</li>
					</ul>
					<p id="center-part_p"
						style="width: 500px; position: relative; left: 29px;">音乐一响起，好似曾经的追剧时光回来了！用一首歌的时间去感受中国电视剧20年！一起来看！</p>
	...
	<div id="right-part">
		<div id="right-part-content">
			<a href="javascript:void(0)" id="user_img"><img
				src="front/image/userimg.jpg" /></a> <a href="javascript:void(0)"
				id="user_name">${sessionScope.user.uname}</a> <a
				href="javascript:void(0)" id="vip_img"><img
		...
		<div class="hot_topic">
			<span class="hot_topic_head">热门话题<a href="javascript:void(0)"
				class="hot_topic_change">换一换</a></span>
			<div class="hot_topic_content">
				<c:forEach items="${Themes}" var="theme">
					<a href="#" class="hot_topic_detail">${theme.tname}</a>
					<span class="hot_topic_detail_click">${theme.tview}</span>
					<br />
				</c:forEach>
		...
		<div class="goodfriend_trends">
			...
			<div class="goodfriend_trends_content">
				...
				<input type="image" src="front/image/attention_friend.png"
					id="goodfriend_attention" />
			</div>
		</div>
	...
	<!-- <div id="foot-part">
        ...
        -->
	<div id="buoys">
		<img src="front/image/letterchat.png" id="buoysimg1" /><span
			id="buoyschat">私信聊天</span><img src="front/image/chatmes.png"
			id="buoysimg2" />
	</div>
	</div>
</body>

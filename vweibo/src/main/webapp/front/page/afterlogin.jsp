		...
		$.ajaxFileUpload({
			...
			success : function(data, status) {
				if (data.rate == -1) {
					...
					newWeiBoStr += '<ul>';
					newWeiBoStr += '<a href="javascript:void(0)" id="choosea1" style="display:inline-block;width:105px;height:3px;position:relative;top:2px;right:-3px;"><img src="front/image/limits_img1.png" id="limits_img" style="position:relative;top:2px;left:6px"/><li class="c1" id="choose1" onClick="changewords()" style="height:12px;position:relative;top:3px;">公开</li></a><br>';
					newWeiBoStr += '<a href="javascript:void(0)" id="choosea1" style="display:inline-block;width:105px;height:3px;position:relative;top:2px;right:-3px;"><img src="front/image/limits_img2.png" id="limits_img" style="position:relative;top:8px;left:6px;"/><li class="c1" id="choose2" onClick="changewords1()" style="height:12px;position:relative;top:8px;">好友圈</li></a><br>';
					newWeiBoStr += '<a href="javascript:void(0)" id="choosea1" style="display:inline-block;width:105px;height:3px;position:relative;top:2px;right:-3px;"><img src="front/image/limits_img3.png" id="limits_img" style="position:relative;top:8px;left:6px;"/><li class="c1" id="choose3" onClick="changewords2()" style="height:12px;position:relative;top:8px;">仅自己可见</li></a>';
					newWeiBoStr += '<a href="javascript:void(0)" id="choosea1" style="display:inline-block;width:105px;height:3px;position:relative;top:2px;right:-3px;"><img src="front/image/limits_img4.png" id="limits_img" style="position:relative;top:8px;left:6px;"/><li class="c1" id="choose4" onClick="changewords3s)" style="height:12px;position:relative;top:8px;">群可见</li></a>';
					newWeiBoStr += '</ul>';
					newWeiBoStr += '</div>';
					newWeiBoStr += '</div>';
...
function findGroupWeiBo(WBUid){
		    ...
		    if(data){
		    	...
		    	for(var zz = 0;zz < 6; zz ++){
					...
					if(yon.indexOf("N") > -1){
						...
						newStr += '<a href="javascript:void(0)" id="choosea1" style="display:inline-block;width:105px;height:3px;position:relative;top:2px;right:-3px;"><img src="front/image/limits_img2.png" id="limits_img" style="position:relative;top:8px;left:6px;"/><li class="c1" id="choose2" onClick="changewords1()" style="height:12px;position:relative;top:8px;">好友圈</li></a><br>';
						newStr += '<a href="javascript:void(0)" id="choosea1" style="display:inline-block;width:105px;height:3px;position:relative;top:2px;right:-3px;"><img src="front/image/limits_img3.png" id="limits_img" style="position:relative;top:8px;left:6px;"/><li class="c1" id="choose3" onClick="changewords2()" style="height:12px;position:relative;top:8px;">仅自己可见</li></a>';
						newStr += '<a href="javascript:void(0)" id="choosea1" style="display:inline-block;width:105px;height:3px;position:relative;top:2px;right:-3px;"><img src="front/image/limits_img4.png" id="limits_img" style="position:relative;top:8px;left:6px;"/><li class="c1" id="choose4" onClick="changewords3()" style="height:12px;position:relative;top:8px;">群可见</li></a>';
						newStr += '</ul>';
						newStr += '</div>';
						newStr += '</div>';
	...
	function selectWeiboByLike(){
		...
		$.ajax({
			  url: "weibo/selectWeiboByLike",
			  cache: false,
			  contentType: "application/x-www-form-urlencoded; charset=UTF-8",
			  data:{"pageSize":pageSize,"pageNum":pageNum,"userid":userid,'character':content},
			  dataType:"json",
			  type:"POST",
			  success: function(data,textStatus){
			    if(data){
...
<body id="bg">
	...
	<input type="hidden" id="uimgPath"
		value="${sessionScope.user.uimgPath}" />
	<input type="hidden" id="weibocount"
		value="${sessionScope.groupnumber.WEIBONUM}" />
	<input type="hidden" id="focuscount"
		value="${sessionScope.groupnumber.FOCUSNUM}" />
	<input type="hidden" id="fanedbocount"
		value="${sessionScope.groupnumber.FANSNUM}" />
	...
	<div id="frame">
		...
		<div id="center-part">
			<div id="center-part-content">
				<p>
					<span id="s1"><img src="front/image/weibonav.png" /></span> <a
						href="javascript:void(0)"><span id="s2" style="color: red;">亚洲新歌音乐节</span></a>
				</p>
				<form action="" method="" enctype="multipart/form-data"
					id="publishForm" name="myfrom">
					<textarea class="W_input" id="txt" title="微博输入框" name="textContent"
						node-type="textE1" content=""></textarea>

					<!--隐藏域 ：op  用来传   0：公开    1：朋友圈       2：.... -->
					<input id="form_push_op" name="op" value="0" type="hidden" /> <a
						href="javascript:void(0)" id="wword"
						onClick="showfaceimage('face_image')"><img
						src="front/image/write_img1.png" id="wimg" />表情</a> <a
						href="javascript:void(0)"
						onClick="showNone('uploadPics','uploadVideo')" id="wword"><img
						src="front/image/write_img2.png" id="wimg" />图片</a> <a
						href="javascript:void(0)"
						onClick="showNone('uploadVideo','uploadPics')" id="wword"><img
						src="front/image/write_img3.png" id="wimg" />视频</a> <a
						href="javascript:void(0)" onClick="showtopicinput('topic_input')"
						id="wword"><img src="front/image/write_img4.png" id="wimg" />话题</a>
					<a href="javascript:void(0)" class="wword" id="moreimg"
						onMouseOver="changemoreimg()" onMouseOut="changemoreimgs()"
						style="position: relative; top: 5px;"><img
						src="front/image/write_img6.png" /></a> <a href="javascript:void(0)"
						id="aa" onClick='showhidediv("choose")'>公开<img
						src="front/image/limits_img5.png" /></a>
					...
					<input type="button" value="发布" id="publish"
						onClick="publishWeibo()" />

					<div id="uploadPics"
						style="display: none; position: relative; z-index: 99; border: 1px solid #CCC;">
						<a href="javascript:void(0)" onclick="createInput('aapic')"
							style="font-size: 14px;">&gt;&gt;添加附件&lt;&lt;</a>
						<div id="aapic"
							style="position: relative; z-index: 99; border: 1px solid #CCC;">
					...
					<div id="uploadVideo"
						...
						<a href="javascript:void(0)" onclick="createInput('bbpic')"
							style="font-size: 14px;">&gt;&gt;添加附件&lt;&lt;</a>
						<div id="bbpic"
							style="position: relative; z-index: 99; border: 1px solid #CCC;">
				...
				<div id="choose" style="display: none;" onMouseUp="hidediv()">
					<a href="javascript:void(0)" class="choosea1" id=""><img
						src="front/image/limits_img1.png" id="limits_img"
						style="position: relative; bottom: 8px;" />
						<li class="c1" id="choose1" data="0" onClick="changeword(this)"
						style="height: 12px; position: relative; bottom: 8px;" />公开
						</li></a><br> <a href="javascript:void(0)" class="choosea1"><img
						src="front/image/limits_img2.png" id="limits_img"
						style="position: relative; bottom: 8px;" />
						<li class="c1" id="choose2" data="1" onClick="changeword(this)"
						style="height: 12px; position: relative; bottom: 8px; right: 5px;">好友圈</li></a><br>
					<a href="javascript:void(0)" class="choosea1"><img
						src="front/image/limits_img3.png" id="limits_img"
						style="position: relative; bottom: 8px;" />
						<li class="c1" id="choose3" data="2" onClick="changeword(this)"
						style="height: 12px; position: relative; bottom: 8px;">仅自己可见</li></a>
					<a href="javascript:void(0)" class="choosea1"><img
						src="front/image/limits_img4.png" id="limits_img"
						style="position: relative; bottom: 8px;" />
						<li class="c1" id="choose4" class="3" onClick="changeword(this)"
						style="height: 12px; position: relative; bottom: 8px;">群可见</li></a>
				</div>

				<div id="face_image" style="display: none;">
					<!-- z-index应该是要和position一起用，this指针只能放在事件里面用  onClick  onMouseOver等 -->
					<a href="javascript:void(0)" onClick="clickFace(this)"
						data="[daku]"><img src="front/image/face_image/daku.png"></a>
					<a href="javascript:void(0)" onClick="clickFace(this)"
						data="[daxiao]"><img src="front/image/face_image/daxiao.png"></a>
					<a href="javascript:void(0)" onClick="clickFace(this)"
						data="[kelian]"><img src="front/image/face_image/kelian.png"></a>
					<a href="javascript:void(0)" onClick="clickFace(this)"
						data="[koubi]"><img src="front/image/face_image/koubi.png"></a>
					<a href="javascript:void(0)" onClick="clickFace(this)"
						data="[shuai]"><img src="front/image/face_image/shuai.png"></a>
					<a href="javascript:void(0)" onClick="clickFace(this)"
						data="[weixiao]"><img src="front/image/face_image/weixiao.png"></a>
					<a href="javascript:void(0)" onClick="clickFace(this)" data="[zan]"><img
						src="front/image/face_image/zan.png"></a>
				</div>

				<div id="topic_input" style="display: none;">
					<a href="javascript:void(0)" onClick="clicktopic(this)"
						id="topic_input_content" data="#在这里输入你想要说的话题#">#插入话题#</a>
				</div>

			</div>

			<div id="navigation" style="display: block">
				<a href="javascript:void(0)" class="na1" onClick="findAllWeiBo()">全部</a> <a
					href="javascript:void(0)" class="na1" onClick="findVideoWeiBo()">视频</a> <a
					href="javascript:void(0)" class="na1" onClick="findPictureWeiBo()">图片</a> <a
					href="javascript:void(0)" class="na1" onClick="findMusicWeiBo()">音乐</a>
				<div id="nav_search">
					<input type="text" id="search_text" placeholder="搜索我关注人的微博" /> <a
						href="javascript:void(0)"><img
						src="front/image/icon_search.png" id="nav-search" onClick="selectWeiboByLike()"/></a> <a
						href="javascript:void(0)" id="nav-icon"
						onMouseOver="changecolor()" onMouseOut="changecolors()"
						onClick='changesupersearch(1)'><img
						src="front/image/navigation_icon.png" /></a>
				</div>
			</div>
			...
			<div id="supersearch"
				...
				<a href="javascript:void(0)" id="superdivclose"
					...
					onClick="changesupersearch(2)"
					onMouseOver="superdivcloseimg2('superdivclose')"><img
					src="front/image/superdivclose.png" id="closepng"></a>
				类&nbsp;&nbsp;&nbsp;型： <input type="checkbox" checked="checked"
					id="check" />转发&nbsp;&nbsp; <input type="checkbox"
					checked="checked" id="check" />纯文字&nbsp;&nbsp; <input
					type="checkbox" checked="checked" id="check" />含图片&nbsp;&nbsp; <input
					type="checkbox" checked="checked" id="check" />含视频&nbsp;&nbsp; <input
					type="checkbox" checked="checked" id="check" />含音乐&nbsp;&nbsp;<br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;关键字：<input type="text"
					id="keyword" placeholder="查找我关注人的微博"
					style="margin-top: 10px; height: 28px;" /><br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;时&nbsp;&nbsp;&nbsp;间：<input
					type="text" id="dateone" placeholder="选择日期"
					style="margin-top: 10px; height: 28px;" />&nbsp;到&nbsp;<input
					type="text" id="datetwo" placeholder="2016-08-30"
					style="height: 28px;" /><br> <input type="image"
					src="front/image/supersearch.png" id="searchbtn"
					style="position: relative; left: 70px; margin-top: 20px;" />
			</div>
          ...
          <div id="center_footnum2_transmit" class="center_footnum2_transmit" style="display:none;">
              ...
              <!-- 评论 -->
				<!-- <div id="comment_div" class="comment_div" style="display: none;">
					...
					<input type="text" id="comment_input" /><br> <a
						...
						src="front/image/write_img1.png" id="comment_pace_png" /></a> <a
						href="javascript:void(0)" id="comment_pace"><img
						src="front/image/write_img2.png" id="comment_pace_png" /></a> <input
						type="checkbox" id="comment_check"><span
					...
					<div id="comment_div_two" class="comment_div_two">
						<a href="javascript:void(0)" class="comment_div_two_a1">全部</a> <a
							href="javascript:void(0)" class="comment_div_two_a">关注的人</a> <a
							href="javascript:void(0)" class="comment_div_two_a">陌生人</a> <a
							href="javascript:void(0)" class="comment_div_two_a2">共<font>10087</font>条
						</a>
					</div>

					<div id="comment_div_three" class="comment_div_three">
						<a href="javascript:void(0)" class="comment_div_three_a1"><img
							src="front/image/comment_header_img.png" id="comment_img"></a>
					...
					<div id="comment_div_four" class="comment_div_four">
						<span class="comment_div_four_a1">9月15日 22:08</span> <a
							href="javascript:void(0)" class="comment_div_four_a"><img
							src="front/image/center-part_foot04.png" /><font
							class="comment_div_four_font">650</font></a> <a
							href="javascript:void(0)" class="comment_div_four_a"
							onclick="showcommentfour('comment_div_four_click')">回复</a> <a
							href="javascript:void(0)" class="comment_div_four_a">举报</a>
					</div>
					<div id="comment_four_first">
						<div id="comment_div_four_click" class="comment_div_four_click"
							style="display: none;">
							<input type="text" id="comment_input"
								class="comment_div_four_input" /><br> <a
								href="javascript:void(0)" id="comment_four_pace"
								class="comment_div_four_pace"><img
								src="front/image/write_img1.png" id="comment_pace_png" /></a> <a
								href="javascript:void(0)" id="comment_four_pace"
								class="comment_div_four_pace"><img
								src="front/image/write_img2.png" id="comment_pace_png" /></a> <input
								type="checkbox" id="comment_four_check"
								class="comment_div_four_check"><span
								id="comment_four_check_span" class="comment_div_four_check">同时转发到我的微博</span>
			...
			<!-- <div id="center-part-content_01">
				<a href="javascript:void(0)" id="center-part_img"><img
					...
					onClick="showcenterhidediv('center-part_choose1')"
					onMouseOver="changecentercolor('center-part_way1')"
					onMouseOut="changecentercolors('center-part_way1')"><img
					src="front/image/conter-part_wayimg01.png" /></a>
				<div style="display: none;" class="center-partchoose"
					id="center-part_choose1"
					onMouseUp="hidecenterdiv('center-part_choose1')">
					<ul>
						<li class="center-partc1" id="center-partchoose1"
							style="height: 20px; width: 130px;"><a
							href="javascript:void(0)" id="center-parta1">帮上头条</a></li>
						<br>
						<li class="center-partc1" id="center-partchoose2"
							style="height: 20px; width: 130px;"><a
							href="javascript:void(0)" id="center-parta1">屏蔽</a></li>
						<br>
						<li class="center-partc1" id="center-partchoose3"
							style="height: 20px; width: 130px;"><a
							href="javascript:void(0)" id="center-parta1">取消关注</a></li>
						<li class="center-partc1" id="center-partchoose4"
							style="height: 20px; width: 130px;"><a
				...
				<ul id="center-part_ul">
					...
					<li
						style="height: 0px; width: 250px; position: relative; left: 18px;"><a
						href="javascript:void(0)">3</a>小时前 来自 weibo.com</li>
				</ul>
				<p id="center-part_p">阿里巴巴集团董事局主席马云成功的十大法则！不要抱怨，寻找机会，时刻拥有梦想，尊重文化，取一个好听的名字</p>
				<div id="content_img01">
					<img src="front/image/weiboimg002.png" />

				</div>


				<div id="center_footnum">
					<a href="javascript:void(0)" id="center_footnum1"
						onClick="addcollectiondiv('center_footnum1_col')"><img
						src="front/image/center-part_foot01.png" id="foot01_imgs" />收藏</a> <a
						href="javascript:void(0)" id="center_footnum2"
						onClick="addtransmitdiv('center_footnum2_transmit')"><img
						src="front/image/center-part_foot02.png" id="foot01_img" />204</a> <a
						href="javascript:void(0)" id="center_footnum3"
						onClick="addcommentdiv1('comment_div1')"><img
						src="front/image/center-part_foot03.png" id="foot01_img" />45</a> <a
						href="javascript:void(0)" id="center_footnum4"><img
						src="front/image/center-part_foot04.png" id="foot01_img" />765</a>
				</div>

				<div id="center_footnum1_col" style="display: none;">
					<div id="collection_div_unline">
						<span id="collection_div_title">收藏</span> <a
							href="javascript:void(0)" id="colle_closepng_a"
							onMouseOut="collectiondivcloseimg('colle_closepng_a')"
							onClick="changecollectionsearch('center_footnum1_col')"
							onMouseOver="collectiondivcloseimg2('colle_closepng_a')"><img
							src="front/image/superdivclose.png" id="colle_closepng"></a>
					</div>
					<div id="collection_div_tishi">
						<img src="front/image/collectionsuccess.png"
							id="collection_div_img" /> <span id="collection_div_su">收藏成功!</span>
					</div>
					<div id="collection_div_word">
						<img src="front/image/tishi.png" id="tishi_img" /><font
							id="tishi_word">添加标签来管理你的收藏</font>
					</div>

					<div id="keyword" style="width: 390px; height: 32px;">
						<input type="text" id="keyword_tip1"
							style="width: 390px; height: 32px;" />

						<div
							style="height: 45px; background: #F0F0F0; width: 430px; position: relative; top: 16px; right: 20px;">
							<input type="image" id="keyword_tip2"
								src="front/image/keyword_add.png" /> <input type="image"
								id="keyword_tip2" src="front/image/keyword_cancel.png"
								onClick="closecollectiondiv('center_footnum1_col')" />
						</div>
					</div>
				</div>
				...
				<div id="center_footnum2_transmit" style="display: none;">
					<div id="transmit_div_unline">
						<span id="transmit_div_title">转发微博</span> <a
							href="javascript:void(0)" id="transmit_closepng_a"
							onMouseOut="transmitdivcloseimg('transmit_closepng_a')"
							onClick="changetransmitsearch('center_footnum2_transmit')"
							onMouseOver="transmitdivcloseimg2('transmit_closepng_a')"><img
							src="front/image/superdivclose.png" id="colle_closepng"></a>
					</div>
					<div id="transmit_header">
						<span id="transmit_header_word">转发到：</span><a
							href="javascript:void(0)" id="transmit_where">我的微博</a>
					</div>
					<textarea class="transmit_input" id="transmit_txt" title="微博输入框"
						node-type="textE1" placeholder="请输入转发理由"></textarea>
					<a href="javascript:void(0)" id="transmit_pace"><img
						src="front/image/write_img1.png" id="transmit_pace_png" /></a> <a
						href="javascript:void(0)" id="transmit_pace"><img
						src="front/image/write_img2.png" id="transmit_pace_png" /></a> <a
						href="javascript:void(0)" id="transmit_aa"
						onClick='showhidetransmitdiv("transmit_choose")'>公开<img
						src="front/image/limits_img5.png" /></a> <input name="imgbtn"
						type="image" src="front/image/transmit_sure.png" id="transmit">

					<div id="transmit_choose" style="display: none;"
						onMouseUp="hidetransmitdiv('transmit_choose')">
						<ul>
							<a href="javascript:void(0)" id="choosea1"><img
								src="front/image/limits_img1.png" id="limits_img"
								style="position: relative; bottom: 8px;" />
							<li class="c1" id="choose1" onClick="changewords()"
								style="height: 12px; position: relative; bottom: 8px;" />公开
								</li></a>
							<br>
							<a href="javascript:void(0)" id="choosea1"><img
								src="front/image/limits_img2.png" id="limits_img"
								style="position: relative; bottom: 8px;" />
							<li class="c1" id="choose2" onClick="changewords1()"
								style="height: 12px; position: relative; bottom: 8px; right: 5px;">好友圈</li></a>
							<br>
							<a href="javascript:void(0)" id="choosea1"><img
								src="front/image/limits_img3.png" id="limits_img"
								style="position: relative; bottom: 8px;" />
							<li class="c1" id="choose3" onClick="changewords2()"
								style="height: 12px; position: relative; bottom: 8px;">仅自己可见</li></a>
							<a href="javascript:void(0)" id="choosea1"><img
								src="front/image/limits_img4.png" id="limits_img"
								style="position: relative; bottom: 8px;" />
							<li class="c1" id="choose4" onClick="changewords3()"
								style="height: 12px; position: relative; bottom: 8px;">群可见</li></a>
						</ul>
					</div>
				</div>
			...
			<div id="center-part-content_01">
				<a href="javascript:void(0)" id="center-part_img"><img
					src="front/image/userphoto004.png" /></a> <a href="javascript:void(0)"
					class="center-part_way" id="center-part_way2"
					onClick='showcenterhidediv("center-part_choose2")'
					onMouseOver="changecentercolor('center-part_way2')"
					onMouseOut="changecentercolors('center-part_way2')"><img
					src="front/image/conter-part_wayimg01.png" /></a>
				<div style="display: none;" class="center-partchoose"
					id="center-part_choose2"
					onMouseUp="hidecenterdiv('center-part_choose2')">
					<ul>
						<li class="center-partc1" id="center-partchoose1"
							style="height: 20px; width: 130px;"><a
							href="javascript:void(0)" id="center-parta1">帮上头条</a></li>
				...
				<!-- <ul id="center-part_ul">
					...
					<li
						...
						href="javascript:void(0)">20</a>分钟前 来自 weibo.com</li>
				</ul>
				...
				<div id="center_footnum">
					<a href="javascript:void(0)" id="center_footnum1"
						...
						src="front/image/center-part_foot02.png" id="foot01_img" />204</a> <a
						href="javascript:void(0)" id="center_footnum3"
						onClick="addcommentdiv2('comment_div2')"><img
						src="front/image/center-part_foot03.png" id="foot01_img" />45</a> <a
						href="javascript:void(0)" id="center_footnum4"><img
						src="front/image/center-part_foot04.png" id="foot01_img" />765</a>
				</div>
	...
	<script>
		function selectPageNo(obj){//这里就是点击页数的情况，
			...
			$.ajax({
				...
				data:{op:"",pageNo:$(obj).val(),'userid':'${user.WBUid}'},//传输的是json的数据格式
				type:'POST',//请求的类型
		...
		function prePage(){
			...
			$.ajax({//这里就是点击前一页的时候，
				url:'weibo/findWeiboByPage',//请求的url地址
				data:{op:"prePage",pageNo:'','userid':'${user.WBUid}'},//传输的是json的数据格式
				type:'POST',//请求的类型
				dataType:'JSON',//返回类型的解析方式  
				success:function(data){
					console.info(data);
		...
		function nextPage(){
			...
			$.ajax({//这里就是点击前一页的时候，
				url:'weibo/findWeiboByPage',//请求的url地址
				data:{op:"nextPage",pageNo:'','userid':'${user.WBUid}'},//传输的是json的数据格式
				type:'POST',//请求的类型
				dataType:'JSON',//返回类型的解析方式  
				success:function(data){
					if(data){
